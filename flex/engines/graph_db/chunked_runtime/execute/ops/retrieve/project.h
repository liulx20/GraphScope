...
#ifndef CHUNKED_RUNTIME_COMMON_OPS_RETRIEVE_PROJECT_H_
#define CHUNKED_RUNTIME_COMMON_OPS_RETRIEVE_PROJECT_H_
...
#endif  // CHUNKED_RUNTIME_COMMON_OPS_RETRIEVE_PROJECT_H_