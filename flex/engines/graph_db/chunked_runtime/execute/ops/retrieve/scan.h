...
#ifndef CHUNKED_RUNTIME_EXECUTE_OPS_RETRIEVE_SCAN_H_
#define CHUNKED_RUNTIME_EXECUTE_OPS_RETRIEVE_SCAN_H_
...
#endif  // CHUNKED_RUNTIME_EXECUTE_OPS_RETRIEVE_SCAN_H_