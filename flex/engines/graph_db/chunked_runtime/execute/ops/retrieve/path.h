...
#ifndef CHUNKED_RUNTIME_EXECUTE_RETRIEVE_OPS_PATH_H_
#define CHUNKED_RUNTIME_EXECUTE_RETRIEVE_OPS_PATH_H_
...
#endif  // CHUNKED_RUNTIME_EXECUTE_RETRIEVE_OPS_PATH_H_