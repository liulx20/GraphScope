...
#ifndef RUNTIME_EXECUTE_OPS_SELECT_H_
#define RUNTIME_EXECUTE_OPS_SELECT_H_
 ...
 public:
  ...
  std::pair<std::unique_ptr<IReadOperator>, ContextMeta> Build(
    ...
    return std::make_pair(
        std::make_unique<SelectOpr>(plan.plan(op_idx).opr().select()),
        ctx_meta);
  }
...
#endif  // RUNTIME_EXECUTE_OPS_SELECT_H_