...
class Expr {
 public:
  ...
  RESULT_T eval_path(size_t idx, Arena&) const;
  RESULT_T eval_vertex(label_t label, vid_t v, size_t idx, Arena&) const;
  RESULT_T eval_edge(const LabelTriplet& label, vid_t src, vid_t dst,
                     const Any& data, size_t idx, Arena&) const;
  RESULT_T eval_path(size_t idx, Arena&, int) const;
  RESULT_T eval_vertex(label_t label, vid_t v, size_t idx, Arena&, int) const;
  RESULT_T eval_edge(const LabelTriplet& label, vid_t src, vid_t dst,
